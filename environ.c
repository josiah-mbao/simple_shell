...
/**
 * _myenv - this is going to print the current environment
...
/**
 * _getenv - it gets the val of an environ variable
 * @info: Structure containing potential arguments. Used to maintain
 * @name: env var name
 *
 * Return: the value
 ...
 * @info: Structure containing the potential args. Used to maintain
 *          constant function prototype.
 * Return: Always 0
 */
