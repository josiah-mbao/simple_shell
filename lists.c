 ...
 * @head: address of pointer to be head node
 * @str: str field of the node
 * @num: node index used by in  history
 *
 ...
 * @head: address of pointer to be first node
 ...
 * @head_ptr: address on pointer to be head node
 *
 * Return: void
 */
